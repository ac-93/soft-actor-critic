...
def kl_policy(x, act_dim, hidden_sizes, activation):
    ...
    return mu, pi, onehot_pi, pi_entropy, action_probs
"""
Actor-Critics
"""
def mlp_actor_critic(x, a, hidden_sizes=[400,300], activation=tf.nn.relu, policy=kl_policy):
    ...
    with tf.variable_scope('pi'):
        mu, pi, onehot_pi, pi_entropy, action_probs = kl_policy(x, act_dim, hidden_sizes, activation)
    ...
    return mu, pi, pi_entropy, action_probs, q1_logits, q2_logits, q1_a, q2_a, q1_pi, q2_pi
